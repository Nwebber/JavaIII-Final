    ...
    <body>
        ...
        <div class="apply-container">
            ...
            <form action="applications" method="POST">
                ...
                <input type="text" name="firstName" value="${fn:escapeXml(application.firstName)}"><br><br>

                <label for="lastName">Last Name: </label>
                <c:if test="${lastNameFailed}">
                    <p class="error">Cannot be blank</p>
                </c:if>
                <input type="text" name="lastName" value="${fn:escapeXml(application.lastName)}"><br><br>

                <label for="email">Email: </label>
                <c:if test="${emailFailed}">
                    <p class="error">Cannot be blank</p>
                </c:if>
                <input type="text" name="email" value="${fn:escapeXml(application.email)}"><br><br>

                <label for="phone">Phone: </label>
                <c:if test="${phoneFailed}">
                    <p class="error">Cannot be blank</p>
                </c:if>
                <input type="text" name="phone" value="${fn:escapeXml(application.phone)}"><br><br>
